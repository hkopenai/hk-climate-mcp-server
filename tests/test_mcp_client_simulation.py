...
class TestMCPClientSimulation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        logger.debug(
            "MCP server subprocess started. Giving it a moment to "
    ...
    async def _call_tool_and_assert(self, tool_name, params):
        ...
        async with streamablehttp_client(self.SERVER_URL) as (
            ...
            async with ClientSession(read_stream, write_stream) as session:
                ...
                self.assertNotIn(
                    "error", data, f"Result should not contain an error: {data}"
                )
                return data
    ...
    def test_get_9_day_weather_forecast_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert("get_9_day_weather_forecast", {"lang": "en"})
        )
    ...
    def test_get_local_weather_forecast_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert("get_local_weather_forecast", {"lang": "en"})
        )
    ...
    def test_get_weather_warning_summary_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert("get_weather_warning_summary", {"lang": "en"})
        )
    ...
    def test_get_weather_warning_info_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert("get_weather_warning_info", {"lang": "en"})
        )
    ...
    def test_get_special_weather_tips_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert("get_special_weather_tips", {"lang": "en"})
        )
    ...
    def test_get_moon_times_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert(
                "get_moon_times", {"year": current_year, "lang": "en"}
            )
        )
    ...
    def test_get_hourly_tides_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert(
                "get_hourly_tides",
                {"station": "QUB", "year": current_year, "lang": "en"},
            )
        )
    ...
    def test_get_tide_station_codes_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert("get_tide_station_codes", {"lang": "en"})
        )
    ...
    def test_get_sunrise_sunset_times_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert(
                "get_sunrise_sunset_times", {"year": current_year, "lang": "en"}
            )
        )
    ...
    def test_get_daily_mean_temperature_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert(
                "get_daily_mean_temperature", {"station": "HKO", "lang": "en"}
            )
        )
    ...
    def test_get_daily_max_temperature_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert(
                "get_daily_max_temperature", {"station": "HKO", "lang": "en"}
            )
        )
    ...
    def test_get_daily_min_temperature_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert(
                "get_daily_min_temperature", {"station": "HKO", "lang": "en"}
            )
        )
    ...
    def test_get_weather_radiation_report_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert(
                ...
                {"date": yesterday, "station": "HKO", "lang": "en"},
            )
        )
    ...
    def test_get_radiation_station_codes_tool(self):
        ...
        asyncio.run(
            self._call_tool_and_assert("get_radiation_station_codes", {"lang": "en"})
        )
